...
To access the scanner functionality: <br />
    ...
    - Ensure a stable and reliable internet connection to efficiently retrieve the necessary data.</p>
          ...
          <div className='flex items-center text-white space-x-2 pt-5 pb-5 '>
            ...
            <p className='text-[15px] sm:text-[17px] font-normal text-black'> To access and update your health profile, follow these simple steps: <br />
        ...
        Maintaining an up-to-date health profile is crucial for personalized care and tailored recommendations. Take control of your well-being by effortlessly managing your health conditions through our user-friendly profile feature.</p>
          ...
          <div className='flex items-center text-white space-x-2 pt-5 pb-5 '>
            ...
            <p className='text-[15px] sm:text-[17px] font-normal text-black'> To reach out to us, please send an email to oluowolabi12@gmail.com</p>
          </div>
          ...
          <div className='flex items-center text-white space-x-2 pt-5 pb-5 '>
            ...
            <p className='text-[15px] sm:text-[17px] font-normal text-black'> At HLV, we take data privacy and security very seriously. Your data is stored with the utmost care and in compliance with stringent security protocols and policies. We prioritize the confidentiality of your information and adhere to strict policies to ensure its protection. <br />
        ...
        <div className='flex items-center text-white space-x-2'>
          ...
          <div className='flex items-center text-white space-x-2 pt-5 pb-5 '>
            ...
            <p className='text-[15px] sm:text-[17px] font-normal text-black'>If you suspect any suspicious activity or unauthorized use of your HLV account, it is important to take immediate action to protect your information. We recommend the following steps: <br />
