...
const Slider = () => {
    ...
    <div >
        ...
        centerMode={false} infinite responsive={responsive} itemClass='item' showDots={true}>
          ...
          {/* 1st Hero slide */}
          <div className='w-full h-[45vh] md:h-[58vh] flex flex-col justify-center items-center bg-cyan-400'>
  <div className='w-full max-w-md grid grid-rows-2 justify-center items-center gap-[1rem] '>
    {/* Image */}
    ...
    <div className='text-center'>
      ...
      <p className='text-white text-lg'>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla, sapiente ipsa? Sed laborum sint illum rerum perspiciatis veniam facere! Neque laudantium veniam architecto. Fugiat aut eos aspernatur, magnam culpa quas!
          ...
          {/* 2nd Hero slide */}
          <div className='w-full h-[55vh] md:h-[58vh] flex flex-col justify-center items-center bg-cyan-400'>
