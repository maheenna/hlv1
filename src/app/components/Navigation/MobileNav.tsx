...
const MobileNav = ({ showNav, closeNav }: Props) => {
  ...
  return (
    <div className={`fixed ${navStyle} right-0 transition-all duration-500 left-0 bottom-0 top-0 bg-[#000000e0] h-[100vh] z-[1002]`}>
      ...
      {/* Nav Divs */}
      <div className={`bg-cyan-400 ${navStyle} transition-all duraton-500 delay-200 flex flex-col items-center justify-center w-[70%] h-[100%]`}>
        ...
        <ul className='space-y-10 '>
          ...
          <li>
            <Link className='text-[35px] font-medium hover:text-blue-500 text-white' href='/FQA'>FQA</Link>
          </li>
          <li>
            <Link className='text-[35px] font-medium hover:text-blue-500 text-white' href='/JoinWaitList'>Join Waitlist</Link>
          </li>
